...
- 매 작업 전 Docs/MasterPlan.md를 최우선 기준으로 읽고, 이어 Docs/PrototypePlan.md, Docs/Decisions.md, Docs/Progress.md를 확인해 관련 항목을 갱신한다.
- Docs/MasterPlan.md는 Git 추적 대상이며, 향후 원격 저장소에 변경 사항을 올릴 때 반드시 함께 커밋·푸시한다.
