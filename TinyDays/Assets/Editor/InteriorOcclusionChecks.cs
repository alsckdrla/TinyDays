    ...
    public static void Execute()
    {
        try
        {
            ...
            for(int cycle=0;cycle<3;cycle++)
            {
                ...
                at(new Vector3(-5,1.5f,6.5f));faded("Home A",true);faded("Home B",false);
                at(new Vector3(-5,3.6f,6.5f));faded("Home A",true);
                at(new Vector3(-7.12f,1.6f,6.5f));faded("Home A",true);
                // Leave the house, but a resident target still lies behind it.
                o.Fade(new Vector3(-5,1.5f,2),new Vector3(-5,1.5f,8),.2f,false,true);faded("Home A",true);
                at(new Vector3(-5,1.5f,2));faded("Home A",false);
            ...
            foreach(string name in new[]{"Home B","Storehouse"}){at(GameObject.Find(name).transform.position+Vector3.up*1.5f);faded(name,true);restored();}
            ...
            at(new Vector3(-5,1.5f,6.5f));review.ResetCameraToPreset();faded("Home A",false);
